...
/*   Updated: 2024/01/17 21:26:01 by andrefil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*ft_read_line(t_vars *lst)
{
	...
	{
		gnl_lstadd_back(&lst->list, gnl_lstnew(lst->buffer[lst->index]));
